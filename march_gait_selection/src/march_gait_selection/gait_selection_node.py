...
from march_shared_resources.msg import CurrentGait, CurrentState
...
def main():
    ...
    def current_gait_cb(gait_name, subgait_name, gait_type):
        current_gait_pub.publish(gait=gait_name, subgait=subgait_name, gait_type=gait_type)
